...
public class MessageControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("/html/body/div/div[3]/div[@data-id=10]").exists())
                .andExpect(xpath("/html/body/div/div[3]/div[5]/div[2]/span").string("fifth"))
                .andExpect(xpath("/html/body/div/div[3]/div[5]/div[2]/i").string("#new one"));
